...
- generated enum and scalar serialization for mixed data types
...
1. Put the host-side Nucleo link on `192.168.1.9` (for example with `tools/configure_nucleo_host_network_macos.sh`).
